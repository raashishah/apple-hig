 ...
 * Required-surface, search, writing, privacy, branding, icons, images, app-icons, inclusion, optional-widget, chrome-backed layout/materials/lists/forms/navigation, host-widget menus/pickers/progress/controls/sliders/scroll-views/popovers/collections/page-controls/labels/text-views/image-views/charts/disclosure-controls/boxes/edit-menus/offering-help/web-views/activity-views/printing/going-full-screen/file-management/focus-and-selection/managing-accounts/tab-views/multitasking/ratings-and-reviews/windows/playing-video/playing-haptics/airplay/gyro-and-accelerometer/home-screen-quick-actions/live-viewing-apps/snippets/generative-ai/always-on/shareplay/nearby-interactions/activity-rings/nfc/augmented-reality/tap-to-pay-on-iphone/id-verifier/apple-in-app-purchase/maps/homekit/workouts/live-photos/icloud/siri/app-shortcuts/healthkit/carplay/sign-in-with-apple/apple-pay/playing-audio/game-center/panels/path-controls/outline-views/imessage-apps-and-stickers/action-button/camera-control/dock-menus/gestures/keyboards/pointing-devices/apple-pencil/game-controls/iphone-duo/carekit/researchkit, system-chrome widgets/Live Activities/status bars/Control Center, RTL, and nested-modal sheets/alerts/modality prose Don'ts apply when every Don't has a scanner.
