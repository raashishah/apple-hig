...
- Host stack
- `knowledge/chrome/recipes.md` for any `structure:chrome.*` in your audit and for each `chromeIds` entry on the lease. Parent runs `scripts/apply-chrome.mjs` after leases for the mechanical dual-stack P0s.
