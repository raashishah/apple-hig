...
- After chrome P0: lease remaining `waveSurfaceIds` from `plan-catalog.mjs`. Cluster catalog topics that share a `surfaceId`. Do not lease `skipped-no-affordance` rows.
