...
A pass can update with a change message. That message is for a real change, not a promotion. The first suggestion to add a pass stays allowed. Logo artwork on the pass does not carry an inner drop shadow. Do not complete an Add to Wallet sheet. Do not invent a logo.
